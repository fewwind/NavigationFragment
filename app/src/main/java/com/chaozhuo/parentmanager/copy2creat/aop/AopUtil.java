...
import com.chaozhuo.parentmanager.util.permission.IPermissionListenerWrap;
import com.chaozhuo.parentmanager.util.permission.PermissionsHelper;
...
public class AopUtil {
    ...
    @Pointcut("execution(@com.chaozhuo.parentmanager.design.compentent.PermissionAOP * *(..))")
