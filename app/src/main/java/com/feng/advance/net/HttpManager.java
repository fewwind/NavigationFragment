...
import com.feng.advance.BuildConfig;
...
//                    jsonObject.put("clientVersion", "1.32");
                ...
                RequestBody requestBody = RequestBody.create(MEDIA_TYPE,
                        jsonObject == null ? parameterStr : jsonObject.toString());
    ...
    public void toList() {
        List<OnLineConfigBean> list =
                new Gson().fromJson("", new TypeToken<List<OnLineConfigBean>>() {
                }.getType());
    }
    ...
    private <T> Type getTypeT(CZCallBack<T> callBack) {
        ...
        return ((ParameterizedType) callBack.getClass()
                .getGenericSuperclass()).getActualTypeArguments()[0];
    }


    private <T> Class<T> getClass(CZCallBack<T> callBack) {
        return (Class<T>) ((ParameterizedType) callBack.getClass()
                .getGenericSuperclass()).getActualTypeArguments()[0];
    }
    ...
    public void cacheMethod() {
        ...
        client.newCall(new Request.Builder().url(douban)
