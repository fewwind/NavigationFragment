...
public class Reflect {
     ...
     * @param name 类的全名
     * @return 反射工具类
     * @throws RuntimeException 如果反射出现意外
     * @see #on(Class)
     */
     ...
     * @see #on(Class)
     */
    public static Reflect on(String name, ClassLoader classLoader) throws RuntimeException {
     ...
     * @throws RuntimeException
     */
    public Reflect callBest(String name, Object... args) throws RuntimeException {
        Class<?>[] types = types(args);
        Class<?> type = type();
        ...
        if (bestMethod != null) {
            ...
            throw new RuntimeException("no method found for " + name, new NoSuchMethodException("No best method " + name + " with params " + Arrays.toString(types)
                    + " could be found on type " + type() + "."));
        }
    }
